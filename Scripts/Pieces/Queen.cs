...
public class Queen : ChessPiecesBase
{
    ...
    public override List<Vector2Int> GetLegalMoves()
    {
        ...
        // Directions for rook-like movement (left, right, up, down)
        ...
        // Directions for bishop-like movement (top-right, top-left, bottom-right, bottom-left)
        ...
        // Combine both rook and bishop movements
        Vector2Int[][] allDirections = new Vector2Int[][] { rookDirections, bishopDirections };
